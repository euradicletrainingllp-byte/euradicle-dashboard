...
import {
  ...
  ChevronLeft, ChevronRight, Zap, Menu, KeyRound,
} from 'lucide-react';
        ...
        {!collapsed && (
          <div className="mt-3 px-3 py-2.5 rounded-xl flex items-center gap-3"
            ...
            <div className="overflow-hidden">
              <p className="text-xs font-semibold truncate" style={{ color: '#f0e8fc' }}>{user?.name || 'Admin'}</p>
              <p className="text-xs truncate" style={{ color: '#7060a0' }}>{user?.role?.replace(/_/g, ' ')}</p>
            </div>
          </div>
        )}
      </div>
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        ...
        <header className="flex items-center justify-between px-6 py-4 flex-shrink-0"
          style={{
            ...
            borderBottom: `1px solid rgba(170,120,166,0.1)`,
          }}>

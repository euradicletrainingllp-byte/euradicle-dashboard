          ...
          <div className="flex items-center gap-4 mb-10">
            ...
            <div>
              <p className="text-xs uppercase tracking-[0.2em] font-semibold mb-0.5"
                style={{ color: 'var(--brand)' }}>EuRadicle</p>
              <p className="text-sm font-bold leading-tight" style={{ color: 'var(--text-heading)' }}>Learning Operations Platform</p>
            </div>
          </div>

          <h1 className="text-3xl font-bold mb-1.5 text-glow" style={{ color: 'var(--text-heading)' }}>Welcome back</h1>
          <p className="text-sm mb-8" style={{ color: 'var(--text-muted)' }}>Sign in to your ELOP account</p>
